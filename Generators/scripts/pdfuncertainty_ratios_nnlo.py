...
parser.add_option("--naivemstw", action="store_true", help="do calculation according to equation 1) instead of 7) 8) in http://arxiv.org/pdf/0905.3531v2", default=False)
...
if str(options.pdf) == 'MSTW':
  ...
  xsections2d = []
  xsections3d = []
  parse(options.dir1, "MSTW2008NNLO68CL", 41, xsections1n)
  #parse(options.dir1, "mstw2008nlo_alphasp.LHgrid", 41, xsections2n)
  #parse(options.dir1, "mstw2008nlo_alphasm.LHgrid", 41, xsections3n)
  parse(options.dir2, "MSTW2008NNLO68CL", 41, xsections1d)
  #parse(options.dir2, "mstw2008nlo_alphasp.LHgrid", 41, xsections2d)
  #parse(options.dir2, "mstw2008nlo_alphasm.LHgrid", 41, xsections3d)
  if options.dir1b != None:
    xsections1n2 = []
    xsections2n2 = []
    xsections3n2 = []
    parse(options.dir1b, "MSTW2008NNLO68CL", 41, xsections1n2)
    #parse(options.dir1b, "mstw2008nlo_alphasp.LHgrid", 41, xsections2n2)
    #parse(options.dir1b, "mstw2008nlo_alphasm.LHgrid", 41, xsections3n2)
...
if str(options.pdf) == "MSTW" :
  if ( len(ratios1) != 41 ):#or len(ratios2) != 41 or len(ratios3) != 41 ):
    ...
    if options.naivemstw:
      pdferror = mstw_pdf_naive(ratios1)
      #print 'MSTW pdf error: %5.3f + %5.3f - %5.3f' %(pdferror[0], pdferror[1], pdferror[2])
      print 'MSTW pdf error: %f + %f - %f' %(pdferror[0], pdferror[1], pdferror[2])
    else: 
