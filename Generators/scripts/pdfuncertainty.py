...
if options.pdf != None and options.scale == False:
  if str(options.pdf) == 'MSTW':
    parse(options.dir, "MSTW2008nlo68cl.LHgrid", 41, xsections1)
    parse(options.dir, "mstw2008nlo_asp.LHgrid", 41, xsections2)
    parse(options.dir, "mstw2008nlo_asm.LHgrid", 41, xsections3)
    if options.dirb != None:
      xsections1_2 = []
      xsections2_2 = []
      xsections3_2 = []
      parse(options.dirb, "MSTW2008nlo68cl.LHgrid", 41, xsections1_2)
      parse(options.dirb, "mstw2008nlo_asp.LHgrid", 41, xsections2_2)
      parse(options.dirb, "mstw2008nlo_asm.LHgrid", 41, xsections3_2)
  ...
  #scale variations
  parse(options.dir, "MSTW2008nlo68cl.LHgrid", 1, xsections1)
  parsescale(options.dir, "MSTW2008nlo68cl.LHgrid", 0, scalevars)
  if options.dirb != None:
    xsections1_2 = []
    scalevars_2 = []
    parse(options.dirb, "MSTW2008nlo68cl.LHgrid", 1, xsections1_2)
    parsescale(options.dirb, "MSTW2008nlo68cl.LHgrid", 0, scalevars_2)
