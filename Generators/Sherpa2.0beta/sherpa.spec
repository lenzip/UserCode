...
./configure --prefix=%i --enable-analysis \
            ...
            CXX="%cms_cxx" CXXFLAGS="-fuse-cxa-atexit $ARCH_CMSPLATF %cms_cxxflags" LDFLAGS="-ldl"
...
make install
#fix missing include
mkdir -p %i/include/AddOns/
cp AddOns/HepMC/HepMC2_Interface.H %i/include/AddOns/
