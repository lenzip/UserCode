...
process.source.fileNames.extend( ['file:tree_CMG.root'] )
...
#store the skimming efficiency
from GeneratorInterface.Core.genFilterEfficiencyProducer_cfi import genFilterEfficiencyProducer
process.skimmingEfficiency = genFilterEfficiencyProducer.clone(filterPath = 'LPPath')
process.e = cms.EndPath(process.skimmingEfficiency)
